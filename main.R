...
cross_val_model <- train(price ~ area + bedrooms + bathrooms + stories + parking, data = housing_data,method = "lm", trControl = train_control)
...
user_data <- data.frame(
  area = input_area,bedrooms = input_bedrooms,bathrooms = input_bathrooms,stories = input_stories,parking = input_parking)
